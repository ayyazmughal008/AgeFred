...
import { getDocuments, postDownloadStatus, getPersonalDoc } from '../../Redux/action'
...
class Documents extends React.Component {
    ...
    getData = () => {
        ...
        this.props.getPersonalDoc(login.data.id)
    }
    ...
    render() {
        const { getDocuments, AuthLoading , getPersonal } = this.props.user
            ...
            <View style={styles.container}>
                ...
                <View style={styles.listView}>
                    ...
                    >
                        {!getPersonal ?
                            <View />
                            : getPersonal.ios.map((item, index) => {
                                return (
                                    <PDFDownload
                                        key={"unique" + index}
                                        title={item.name}
...
export default connect(mapStateToProps, { getDocuments, postDownloadStatus, getPersonalDoc })(Documents);